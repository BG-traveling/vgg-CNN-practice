...
BASE_DIR = Path(r'C:\kdh\machine_deep\deep\Data') 
...
#최종 증강 파이프라인
#나의 trian image, labels -> 모두 증강하는 반복문
def pipe_augmentation(n=3):
    ...
    #images_files 는 images/train 안에 있는 모든 그림 파일
    # image_dir = Path(r'C:\kdh\머신러닝, 딥러닝\deep\Data\YoloAugmentation\images\train')
