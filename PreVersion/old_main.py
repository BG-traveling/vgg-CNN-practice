...
def run_epoch(model, history, EPOCHS=10):
    ...
    prograss_bar = tqdm(range(1, EPOCHS+1))

    for e in prograss_bar:
            #평균 loss, 맞춘 비율 %
            ...
            prograss_bar.set_postfix({'train_loss':f'{train_loss:.2f}',
...
if __name__ == '__main__':
    ...
    save_path = r'C:\kdh\머신러닝, 딥러닝\로컬1일차_샘플\image\result.jpg'
    model_graph = draw_plot(model_history, save_path)